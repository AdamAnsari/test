...
@section('body')
    ...
    <form action="/api/student/{{$students->id}}" method="POST">
      @csrf
      {{method_field('PUT')}}
      <div class="form-group">
        <label for="name" class="font-weight-bold">Name:</label>
        <input type="text" class="form-control" id="name" placeholder="Enter Name" name="name" value={{ $students->name }}>
      </div>

      <div class="form-group">
        <label for="birthday" class="font-weight-bold">Birthday:</label>
        <input type="text" class="form-control" id="birthday" placeholder="Enter Birthday" name="birthday" value={{ $students->birthday }}>
      </div>
      ...
      <div class="form-group">
        ...
        <select class="form-control form-control-lg" name="state" id="state" onchange="random()">
          <option value="000">{{ $students->state }}</option>
      ...
      <div class="form-group">
        ...
        <div id="city" class="form-control">{{ $students->city }}</div>
      </div>

      <div class="form-group">
        <label for="education" class="font-weight-bold">Education:</label>
        <input type="text" class="form-control" id="education" placeholder="Enter Education" name="education" value={{ $students->education }}>
      </div>

      <div class="form-group">
        <label for="year" class="font-weight-bold">Year-Of-Completion:</label>
        <input type="text" class="form-control" id="year" placeholder="Enter Year-Of-Completion" name="year" value={{ $students->year }}>
      </div>
      ...
      <div class="form-group desc 0" style="display: none;">
        ...
        <input type="text" class="form-control" id="company" placeholder="Enter Company Name" name="company" value={{ $students->company }}>
      </div>

      <div class="form-group desc 0" style="display: none;">
        <label for="job-started" class="font-weight-bold">Job Started from:</label>
        <input type="text" class="form-control" id="job-started" placeholder="Enter Job Started from" name="job_started" value={{ $students->job_started }}>
      </div>

      <div class="form-group desc 1" style="display: none;">
        <label for="business-name" class="font-weight-bold">Business Name:</label>
        <input type="text" class="form-control" id="business-name" placeholder="Enter Business Name" name="business_name" value={{ $students->business_name }}>
      </div>

      <div class="form-group desc 1" style="display: none;">
        <label for="location" class="font-weight-bold">Location:</label>
        <input type="text" class="form-control" id="location" placeholder="Enter location" name="location" value={{ $students->location }}>
      </div>
     
      <div class="form-group">
        <label for="email" class="font-weight-bold">Email Id:</label>
        <input type="email" class="form-control" id="email" placeholder="Enter Email Id" name="email" value={{ $students->email }}>
      </div>

      <div class="form-group">
        <label for="mobile" class="font-weight-bold">Mobile No:</label>
        <input type="text" class="form-control" id="mobile" placeholder="Enter Mobile No" name="mobile" value={{ $students->mobile }}>
      </div>
